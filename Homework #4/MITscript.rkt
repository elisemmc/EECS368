...
;;;Definition of user-interactive-environment in terms of Standard scheme
...
(define-syntax cons-stream
  (syntax-rules() ((cons-stream x y) (cons x (delay y)))))
...
;;;----------
;;;To make the Logic Programming system start up with the Microshaft
;;;knowledgebase when you hit the RUN button
(initialize-data-base microshaft-data-base)
(query-driver-loop)
;;;----------